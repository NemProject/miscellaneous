            ...
            {variant === 'internal' && (
                <button className="link" {...rest}>
                    ...
                    {!hideArrows && (
                        ...
                        4 4.63862 4H6.8877ZM14.8877 4C15.045 4 15.193 4.07396 15.2875 4.19968L20.9218 0"
                            />
                        </svg>
                    )}
                </button>
