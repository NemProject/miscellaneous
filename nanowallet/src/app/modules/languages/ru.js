function RussianProvider($translateProvider) {
    ...
    $translateProvider.translations('ru', {
        ...
        OPTIN_TAC_INFO_1:'Процесс Опт Ин - это функция, которая запущенна от NEM Group Limited с целью помочь пользователям сети NIS1 отзеркалить свои балансы в новую сеть Symbol. Данный процесс, содержит определенные правила, которые должны строго соблюдаться всеми участниками, которые его выполняют.',
        OPTIN_TAC_INFO_2:'Компания NEM Group Limited не будет нести ответственность, за любые инциденты, выходящие за рамки условий, указанных ниже.',
