function JapaneseProvider($translateProvider) {
    ...
    $translateProvider.translations('jp', {
      ...
      DASHBOARD_NOTICE_1: 'NEM Wallet にようこそ！',
      DASHBOARD_NOTICE_2: '問題の報告は<a href="https://github.com/NemProject/miscellaneous" target="_blank">こちら</a>へお願いします。',
      DASHBOARD_NOTICE_3: 'NEM チームは、メインネットを利用する前に、最初にテストネットにて NEM Wallet の操作を行い、利用方法を習得する事をお勧めします。英文のガイドブックは<a href="https://docs.nem.io/pages/Guides/nanowallet/docs.en.html" target="_blank">こちら</a>にあります。利用者は自身の資金を管理し、秘密鍵をバックアップしてください。NEM チームは、メインネット上でこのアプリケーションを利用することに起因する、資金の消失について責任を負いません。',
      ...
      FAQ_ANSWER_11_1: '最初にあなたのトランザクションを<a target="_blank" href="https://nemscan.io/">エクスプローラー</a>上に表示されるか確認してください。(エクスプローラーには数ブロック程度の遅延があります)',
      ...
      FAQ_ANSWER_12_2: 'ブロック高について<a target="_blank" href="https://nemnodes.org/nodes/">ここ</a>で表示できる高さと比較してみてください。',
