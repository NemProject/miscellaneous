function JapaneseProvider($translateProvider) {
    ...
    $translateProvider.translations('jp', {
      ...
      GENERAL_LEVY_TYPE_2: 'パーセンテージ型手数料',
      GENERAL_SEND: "送信",
      GENERAL_TO: "宛先",
      GENERAL_HASH: "ハッシュ",
      ...
      LINE_TX_DETAILS_LEVY_TYPE_2: "パーセンテージ",
      ...
      MOSAIC_DEFINITION_LEVY_FEE_TYPE_2: "パーセンテージ徴収方式",
      MOSAIC_DEFINITION_LEVY_FEE_TYPE_1_NOTE: "固定徴収方式を選択すると、固定の徴収が発生します。",
      MOSAIC_DEFINITION_LEVY_FEE_TYPE_2_NOTE: "パーセンテージ徴収方式を選択すると、送信量により徴収量が変動します。",
      ...
      MOSAIC_DEFINITION_INFORMATION_13: "手数料の種類: 固定徴収方式とパーセンテージ徴収方式の2種類があります。",
      MOSAIC_DEFINITION_INFORMATION_14: "固定徴収方式の場合、徴収額は転送される量に依存しません。",
      MOSAIC_DEFINITION_INFORMATION_15: "パーセンテージ徴収方式の場合、徴収額は送信するモザイクの量に従って変化します。",
