function JapaneseProvider($translateProvider) {
    ...
    $translateProvider.translations('jp', {
      ...
      FAQ_ANSWER_11_1: '最初にあなたのトランザクションを<a target="_blank" href="https://nem.fyi/">エクスプローラー</a>上に表示されるか確認してください。(エクスプローラーには数ブロック程度の遅延があります)',
      ...
      FAQ_ANSWER_12_2: 'ブロック高について<a target="_blank" href="https://nem.fyi/nodes/">ここ</a>で表示できる高さと比較してみてください。',
