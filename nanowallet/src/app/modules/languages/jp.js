function JapaneseProvider($translateProvider) {
    ...
    $translateProvider.translations('jp', {
      ...
      POST_OPTIN_INFO_2:                      'スナップショットブロックでXEMを保有していた場合、_________を使ってXYMを請求できます。',
      ...
      POST_OPTIN_DEST_MSIG:                   '送信先のマルチシグ公開鍵を入力してください。このアカウントはマルチシグでなければならず、現在のNIS1マルチシグアカウントと同じ数の連署者がいなければなりません。',
      ...
      OPTIN_STATUS_TEXT_5:                    'あなたのオプトインリクエストは正常に行われました。',
      ...
      OPTIN_PUBLICKEY_PLACEHOLDER:            '公開鍵は16進数で64文字でなければなりません',
      OPTIN_DONE:                             '完了',
      OPTIN_ERROR_TITLE_0:               '署名が有効でないため、このオプトインリクエストは失敗しました。',
      OPTIN_ERROR_TITLE_1:               '送信先アカウントが有効でないため、このオプトインリクエストは失敗しました。',
      OPTIN_ERROR_TITLE_2:               '1名または複数の連署者が有効でなかったため、このオプトインリクエストは失敗しました。',
      OPTIN_SIGNED:                           '署名済み',
    });
