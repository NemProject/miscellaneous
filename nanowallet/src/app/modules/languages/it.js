function ItalianProvider($translateProvider) {
    ...
    $translateProvider.translations('it', {
        ...
        DASHBOARD_NOTICE_1: 'Benvenuto in NEM Wallet!',
        DASHBOARD_NOTICE_2: 'Prego <a href="https://github.com/NemProject/miscellaneous" target="_blank">segnalare problemi qui</a>.',
        DASHBOARD_NOTICE_3: 'Il team NEM suggerisce di testare prima su TestNet per familiarizzare con NEM Wallet prima di utilizzare la rete principale MainNet. Una guida semplice può essere trovata <a href="https://docs.nem.io/pages/Guides/nanowallet/docs.en.html" target="_blank">qui</a>. Gli utenti sono responsabili della sicurezza dei fondi e del mantenimento di un backup sicuro di tutte le proprie chiavi private.Il team NEM non è responsabile per eventuali perdite di fondi dovute a un uso improprio di questa applicazione sulla rete principale (MainNet).',
        ...
        FAQ_ANSWER_11_1: 'Prima devi verificare che l"hash della tua transazione stia puntando a una transazione esistente in <a target="_blank" href="https://nemscan.io/"> explorer </a> (tieni presente che la explorer è sempre a pochi isolati di distanza).',
        ...
        FAQ_ANSWER_12_2: 'Controllare il numero del blocco e confrontarlo con il numero visualizzato <a target="_blank" href="https://nemnodes.org/nodes/">qui</a>.',
