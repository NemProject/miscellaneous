function UkrainianProvider($translateProvider) {
    ...
    $translateProvider.translations('uk', {
        ...
        FAQ_ANSWER_11_1: 'По-перше, Ви повинні перевірити, що хеш Вашої транзакції дійсно вказує на існуючу транзакцію у <a target="_blank" href="https://nem.fyi/">провіднику</a> (будь-ласка, майте на увазі, що провідник відображає інформацію із запізненням на декілька блоків).',
        ...
        FAQ_ANSWER_12_2: 'Подивіться на висоту блоків та порівняйте її з показником, який відображений <a target="_blank" href="https://nem.fyi/nodes/">тут</a>.',
