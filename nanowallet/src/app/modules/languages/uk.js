function UkrainianProvider($translateProvider) {
    ...
    $translateProvider.translations('uk', {
        ...
        DASHBOARD_NOTICE_1: 'Вітаємо у NEM Wallet!',
        DASHBOARD_NOTICE_2: 'Будь-ласка, <a href="https://github.com/NemProject/miscellaneous" target="_blank">повідомте про помилку тут</a>.',
        DASHBOARD_NOTICE_3: 'Команда NEM радить, перед тим, як користуватись основною мережею (mainnet), ознайомитись з усіма функціями NEM Wallet у тестовій мережі (testnet). Простий довідник можна знайти <a href="https://docs.nem.io/pages/Guides/nanowallet/docs.en.html" target="_blank"> тут </a>. Користувачі самі несуть відповідальність за збереження своїх коштів та створення резервних копій приватних ключів. Команда NEM не несе відповідальності за будь-яку втрату коштів через використання цього додатку в головній мережі (mainnet).',
        ...
        FAQ_ANSWER_11_1: 'По-перше, Ви повинні перевірити, що хеш Вашої транзакції дійсно вказує на існуючу транзакцію у <a target="_blank" href="https://nemscan.io/">провіднику</a> (будь-ласка, майте на увазі, що провідник відображає інформацію із запізненням на декілька блоків).',
        ...
        FAQ_ANSWER_12_2: 'Подивіться на висоту блоків та порівняйте її з показником, який відображений <a target="_blank" href="https://nemnodes.org/nodes/">тут</a>.',
        ...
        OPTIN_TAC_TITLE:'Правила та умови',
        OPTIN_TAC_TEXT:'правила та умови',
        OPTIN_TAC_INFO_1:'Процес Опт-ін - це функція, яку запускає Symbol Chain Limited з метою допомогти користувачам NIS1 перенести свої баланси на нову мережу Symbol. Це процес, визначений певними параметрами, якого повинні дотримуватися всі користувачі.',
        OPTIN_TAC_INFO_2:'Компанія Symbol Chain Limited не несе відповідальності за будь-які інциденти поза межами термінів та умов, зазначених нижче.',
        OPTIN_TAC_READ_ACCEPT: 'Я прочитав і приймаю ',
        OPTIN_TAC_READ_ACCEPT_POST: ' ',
        OPTIN_CONFIRM_TITLE:'Підтвердити Symbol Опт-ін',
        OPTIN_CONFIRM_INFO:'Ми майже закінчили! Це буде інформація, яка буде перенесена до нового блокчейну Symbol. Уважно перегляньте її та підпишіть ключем NEM, щоб завершити Опт-ін.',
        OPTIN_CONFIRM_OPTIN:'Підтвердити Opt-in',
        HERE:'тут',
        OPTIN_ENTER_PASSWORD: 'Введіть свій пароль NEM NIS1, щоб підписати Опт-ін.',
        OPTIN_LOADING: 'Завантаження...',
        OPTIN_FINISHED: 'Програма Опт-ін завершена, будь ласка, оновіть додаток, щоб отримати останні відомості',
        CREATE_SYMBOL_ACCOUNT: 'Створіть Ваш акаунт Symbol',
        OPTIN_SYMBOL_READY: 'Ваш акаунт Symbol готовий',
        OPTIN_COPY_SUCCESS: 'Скопійовано!',
