function UkrainianProvider($translateProvider) {
    ...
    $translateProvider.translations('uk', {
        ...
        LEDGER_NANO_NOT_USING_NEM_APP: 'Ви не використовуєте додаток NEM BOLOS на вашому пристрої Ledger',
        LEDGER_NANO_NOT_USING_XYM_APP: 'Ви не використовуєте додаток Symbol BOLOS на вашому пристрої Ledger',
        LEDGER_NANO_NOT_SUPPORTED_APP: 'Будь ласка, перевірте чи відкрита остання версія додатку NEM на Вашому пристрої Ledger',
      LEDGER_NANO_CONNECTED_OTHER_APP: `Ваш пристрій Ledger під'єднується до Ledger Live. Будь ласка, закрийте це та продовжуйте далі`,
        LEDGER_NANO_NOT_OPENED_NEM_APP: 'Будь ласка, відкрийте додаток NEM BOLOS на вашому пристрої Ledger',
        LEDGER_NANO_NOT_OPENED_XYM_APP: 'Будь ласка, відкрийте додаток Symbol BOLOS на вашому пристрої Ledger',
