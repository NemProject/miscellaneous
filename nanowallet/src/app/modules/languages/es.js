function SpanishProvider($translateProvider) {
    ...
    $translateProvider.translations('es', {
        ...
        DASHBOARD_NOTICE_1: 'Bienvenido(a) a la NEM Wallet!',
        DASHBOARD_NOTICE_2: 'Por favor <a href="https://github.com/NemProject/miscellaneous" target="_blank">reportar incidencias aquí</a>.',
        DASHBOARD_NOTICE_3: 'El equipo de NEM sugiere hacer pruebas en el testnet para familiarizarse primero con NEM Wallet antes de usar el mainnet. Se puede encontrar una guía simple <a href="https://docs.nem.io/pages/Guides/nanowallet/docs.en.html" target="_blank"> aquí </a>. Los usuarios son responsables de sus fondos y de realizar una copia de seguridad de sus claves privadas. El equipo de NEM no es responsable de ninguna pérdida de fondos debido al uso de esta aplicación en la red mainnet.',
        ...
        FAQ_ANSWER_11_1: 'Primero debes verificar que el hash de tu transacción apunte a una transacción existente en el <a target="_blank" href="https://nemscan.io/">explorador</a> (ten en cuenta que el explorador está a unos pocos bloques por detrás).',
        ...
        FAQ_ANSWER_12_2: 'Mira el tamaño de la cadena y compárala con el tamaño que se muestra <a target = "_ blank" href="https://nemnodes.org/nodes/">aquí</a>.',
        ...
        POST_OPTIN_CONFIRM_MODAL_TITLE:         'Atención!',
