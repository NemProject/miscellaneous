function EnglishProvider($translateProvider) {
    ...
    $translateProvider.translations('en', {
        ...
        DASHBOARD_NOTICE_1: 'Welcome to the NEM Wallet!',
        DASHBOARD_NOTICE_2: 'Please <a href="https://github.com/NemProject/miscellaneous" target="_blank">report issues here</a>.',
        DASHBOARD_NOTICE_3: 'The NEM Team suggests primarily testing on the testnet to familiarize yourself with the NEM Wallet first before using the mainnet. A simple guide can be found <a href="https://docs.nem.io/pages/Guides/nanowallet/docs.en.html" target="_blank">here</a>. Users are responsible for their funds and having their private keys backed up. The NEM team is not responsible for any loss of funds due to using this app on the mainnet.',
