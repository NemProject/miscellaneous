function ChineseProvider($translateProvider) {
    ...
    $translateProvider.translations('cn', {
        ...
        POST_OPTIN_INFO_2:                      '如果账户在选择加入快照块上包含XEM，则可以获取XYM',
        ...
        POST_OPTIN_DEST_MSIG:                   '请输入Symbol多签账户公钥。 NIS和Symbol的多签账户的共同签名账户数量必须一致',
        ...
        OPTIN_NOT_AVAILABLE:                    '您的快照区块上没有没有足够余额',
