function ChineseProvider($translateProvider) {
    ...
    $translateProvider.translations('cn', {
        ...
        FAQ_ANSWER_11_1: '首先，您必须检查您的交易的哈希是否指向现有的交易，在 <a target="_blank" href="https://nemscan.io/">explorer</a> (请注意，浏览器落后几个块).',
        ...
        FAQ_ANSWER_12_2: '查看链条高度并将其与所示高度进行比较 <a target="_blank" href="https://nemnodes.org/nodes/">here</a>.',
