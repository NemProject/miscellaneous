function DutchProvider($translateProvider) {
    ...
    $translateProvider.translations('nl', {
        ...
        ACCOUNT_VESTED_BALANCE: 'Gevestigde balans',
        ACCOUNT_HARVESTING: 'Oogsten',
        ACCOUNT_REMOTE_STATUS: 'Remote status',
        ACCOUNT_DELEGATED_PUBLIC: 'Gedelegeerde publieke sleutel',
        ACCOUNT_HARVESTED_BLOCKS: 'Geoogste blokken',
        ACCOUNT_START_STOP_HARVESTING: 'Start/Stop gedelegeerd oogsten',
        ACCOUNT_HARVESTING_NOTE: 'De node die voor dit account wordt gebruikt om te oogsten, is opgeslagen in uw <b>lokale opslagruimte van de browser</b>. Als de browser-opslag wordt gewist, weet de het programma niet welke node u gebruikte en daarom zal de <b>oogststatus</b> op <b>inactief</b> staan. Selecteer in dit geval de node die u gebruikte en de oogststatus zal automatisch worden hersteld. Als de status niet wordt hersteld, controleer of u de juiste node hebt geselecteerd; anders betekent het dat de node is herstart en uw account niet meer aan het oogsten is.',
        ...
        ACCOUNT_HARVESTING_NO_SLOTS: 'Geen vrije sloten op geselecteerde node, selecteer een andere',
        ACCOUNT_HARVESTING_BELOW_THRESHOLD: 'Je hebt minimaal 10.000 gevestigde XEM nodig om gedelegeerd te kunnen oogsten',
        ACCOUNT_ACCOUNT_SELECT: 'Selecteer een ander account',
        ACCOUNT_ACCOUNT_SELECT_LABEL: 'Slecteer account',
        ACCOUNT_WALLET_KEYS: 'Portemonnee & sleutels',
        ACCOUNT_ADD_NEW_ACCOUNT: 'Voeg account toe',
        ACCOUNT_ADD_NEW_ACCOUNT_BTN: 'Voeg een nieuw account toe aan de portemonnee',
        ACCOUNT_PRIVATE_KEY_NOTE: 'Uw privé-sleutel bevat alle informatie van uw account. Het is van zeer groot belang dat je deze veilig ergens <b><u>offline</u></b> opslaat: d.m.v. een wachtwoord opgeslagen in een .wlt-bestand, op een stuk papier geschreven of op een foto of download het <b><u>exporteer portemonnee QR</u></b>.',
        ACCOUNT_PRIVATE_KEY_SHOW: 'Toon privé-sleutel',
        ACCOUNT_EXPORT_MOBILE: 'Exporteer naar mobiel',
        ACCOUNT_INFO_QR_BTN: 'Deel account informatie QR',
        ...
        ACCOUNT_BACKUP_WALLET_NOTE: 'Het is <b><u>zeer belangrijk</u></b> dat je back-ups van de portemonnees hebt, anders is de XEM verloren.',
