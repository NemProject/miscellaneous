function DutchProvider($translateProvider) {
    ...
    $translateProvider.translations('nl', {
        ...
        DASHBOARD_NOTICE_2: '<a href="https://github.com/NemProject/miscellaneous" target="_blank">Meldt hier problemen</a>.',
        DASHBOARD_NOTICE_3: 'Het NEM-team adviseert je om eerst op het Testnet vertrouwd te raken met NEM Wallet voordat je het Mainnet gaat gebruiken. Een eenvoudige gids vindt je <a href="https://docs.nem.io/pages/Guides/nanowallet/docs.en.html" target="_blank"> hier</a>. Gebruikers zijn zelf verantwoordelijk voor hun geld en moeten zelf van de persoonlijke sleutels een back-up maken. Het NEM-team is niet verantwoordelijk voor het verlies van geld door deze applicatie op het Mainnet te gebruiken.',
        ...
        FAQ_ANSWER_11_1: 'Eerst moet u controleren of de hash van uw transactie naar een bestaande transactie in de <a target="_blank" href="https://nemscan.io/">verkenner</a> verwijst (houd er rekening mee dat de verkenner een paar blokken achter kan lopen).',
        ...
        FAQ_ANSWER_12_2: 'Kijk naar de blokhoogte en controleer het met de hoogte zoals <a target="_blank" href="https://nemnodes.org/nodes/">hier</a> weergegeven.',
