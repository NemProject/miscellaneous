function DutchProvider($translateProvider) {
    ...
    $translateProvider.translations('nl', {
        ...
        ACCOUNT_IMPORTANCE_SCORE: 'Belangrijkheids-score',
        ACCOUNT_VESTED_BALANCE: 'Toegekende balans',
        ACCOUNT_HARVESTING: 'Oogsten',
        ACCOUNT_REMOTE_STATUS: 'Status op afstand oogsten',
        ...
        ACCOUNT_HARVESTING_NOTE: 'De node waarop u oogst wordt opgeslagen in uw <b>locale browsergeschiedenis</b>. Als uw lokale browsergeschiedenis verwijderd wordt dan weet de app niet meer welke node u gebruikte. De <b>oogst status</b> zal dan <b>inactief</b> lijken. Selecteer als dit het geval is de node die u gebruikte en dan wordt de oogst status automatisch weer bijgewerkt. Mocht de status niet herstelt zijn, check dan eerst of u de goede node heeft geselecteerd. Als dit het geval is dat betekend dit dat de node opnieuw is opgestart en dat uw account niet meer oogst.',
        ...
        ACCOUNT_HARVESTING_NO_SLOTS: 'Er zijn geen vrije plekken op de door u gekozen node, kies alstublieft een andere',
        ACCOUNT_HARVESTING_BELOW_THRESHOLD: 'U heeft op zijn minst een balans van 10\'000 toegekende XEM nodig om gedelegeerd oogsten te starten',
        ...
        ACCOUNT_ADD_NEW_ACCOUNT_BTN: 'Voeg een nieuw account to aan uw portomonnee',
        ACCOUNT_PRIVATE_KEY_NOTE: 'Uw privé-sleutel geeft volledige toegang tot uw account. Het is uiterst belangrijk dat u deze ergens <b><u>offline</u></b> op slaat. Zorg dat u deze versleuteld in een .wlt bestand heeft, heeft opgeschreven op een stukje papier, er een foto van heeft gemaakt of de <b><u>exporteer portemonnee</u></b> heeft.',
        ACCOUNT_PRIVATE_KEY_SHOW: 'Geef privé-sleutel weer',
        ...
        ACCOUNT_BACKUP_WALLET_NOTE: 'Het is <b><u>uiterst belangrijk</u></b> dat u back-ups heeft van uw portemonnees. Heeft u dit niet dan loopt u het risico dat uw XEM verloren gaat.',
        ...
        ACCOUNT_ADD_NEW_ACCOUNT_WARNING: 'Alle accounts zijn afgeleid van uw primaire privé-sleutel en wachtwoord doormiddel van BIP32, dus uw primaire privé-sleutel en uw wachtwoord zijn beide nodig om uw secundaire accounts te laden. Het wordt <b>sterk aangeraden</b> om een back-up te maken van uw portemonnee nadat u nieuwe accounts heeft toegevoegd om te voorkomen dat u de acties moet herhalen als uw lokale opslag verwijderd wordt.',
        ...
        APOSTILLE_INFORMATION_2: '"<b>Privé, overdraagbaar en bewerkbaar</b>" optie betekent dat de hashes van uw bestanden zijn ondertekend met uw privé-sleutel en verzonden naar een specifiek hiërarchisch deterministisch (HD) account. Op deze manier is het niet mogelijk voor iemand anders om te weten welke inhoud gemarkeerd is met de tijd, tenzij u de inhoud deelt.',
        ...
        APOSTILLE_INFORMATION_5: 'Voor accounts in een multi-handtekeningcontract waar "<b>Privé, overdraagbaar en bewerkbaar</b>" is geselecteerd, wordt de privé-sleutel van de initiële mede-ondertekenaar gebruikt om de hash te ondertekenen en een speciaal HD-account aan te maken, niet het multi-handtekening account.',
        APOSTILLE_INFORMATION_6: 'Het HD-account is een speciaal account dat wordt gegenereerd van de hash van de bestandsnaam die vervolgens door uw privé-sleutel is ondertekend. De resulterende hash van dit proces wordt dan gebruikt om een tweede privé-sleutel te maken. Dit is de privé sleutel van het bestand met de tijdstempel; de eerste in blockchain technologie die alleen alleen in Apostille wordt gevonden.',
        APOSTILLE_INFORMATION_7: 'Met het speciale HD-account kunt u de originele ondertekende hash en de updates van een speciaal account opslaan. Als "<b>Openbaar</b>" is geselecteerd, gaat de transactie naar de openbare vergaarbak (standaard).',
