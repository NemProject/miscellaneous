function DutchProvider($translateProvider) {
    ...
    $translateProvider.translations('nl', {
        ...
        ACCOUNT_ADD_NEW_ACCOUNT_BTN: 'Voeg een nieuw account to aan uw portemonnee',
        ...
        SIGNUP_BRAIN_WALLET_WARNING: 'Lees alstublieft over <a href="https://en.bitcoin.it/wiki/Brainwallet" rel="nofollow" target="_blank"> gevaren </a> die brein portemonnee vormen. Brein portemonnees gebruikt ALLEEN de wachtwoordzin-hash meerdere keren. Daarom is het van cruciaal belang een VEILIGE wachtwoordzin te selecteren met minstens 40 karakters. <a href="https://xkcd.com/936/" rel="nofollow" target="_blank"> XKCD #936 </a>',
        SIGNUP_PRIVATE_KEY_WALLET_WARNING: 'Persoonlijke sleutel portemonnees gebruiken ALLEEN een wachtwoord om de geïmporteerde privé-sleutel te coderen. Daarom is het van cruciaal belang om een veilig wachtwoord te selecteren.',
        ...
        SIGNUP_COMMON_WALLET_WARNING_3: 'Als u het bestand <b><i>.wlt</i></b> niet krijg, klikt u op onderstaande knop om de ruwe portemonneegegevens te openen en het bestand handmatig te maken:',
        SIGNUP_COMMON_WALLET_WARNING_4: 'Zelfs als u een portemonnee hebt, is het <b><u>verplicht</u></b> om de privé-sleutel van uw account te maken, klik op onderstaande knop om het te onthullen:',
        ...
        // FORM RELATED
        FORM_PASSWORD_FIELD_PLACEHOLDER: 'Voer uw portemonnee wachtwoord of wachtwoordzin in',
