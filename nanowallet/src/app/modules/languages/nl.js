function DutchProvider($translateProvider) {
    ...
    $translateProvider.translations('nl', {
        ...
        MOSAIC_DEFINITION_INFORMATION_9: 'De maker kan eisen dat een speciale vergoeding van de afzender wordt verzameld en naar een rekening van zijn keuze wordt verzonden (dus de maker kan zijn eigen rekening als ontvanger van deze vergoeding opgeven). De gegevens voor de heffing zijn de volgende:',
        MOSAIC_DEFINITION_INFORMATION_10: 'Het mozaïek waarin de vergoeding moet worden betaald. Elk bestaand mozaïek kan worden geselecteerd.',
        ...
        ACCOUNT_ADD_NEW_ACCOUNT_WARNING: 'Alle accounts zijn afgeleid van uw primaire persoonlijke sleutel en wachtwoord doormiddel van BIP32, dus uw primaire persoonlijke sleutel en uw wachtwoord zijn beide nodig om uw secundaire accounts te laden. Het wordt <b>sterk aangeraden</b> om een back-up te maken van uw portemonnee nadat u nieuwe accounts heeft toegevoegd om te voorkomen dat u de acties moet herhalen als uw lokale opslag verwijderd wordt.',
        ...
        APOSTILLE_INFORMATION_2: '"<b>Persoonlijk, overdraagbaar en bewerkbaar</b>" optie betekent dat de hashes van uw bestanden zijn ondertekend met uw persoonlijke sleutel en verzonden naar een specifiek hiërarchisch deterministisch (HD) account. Op deze manier is het niet mogelijk voor iemand anders om te weten welke inhoud gemarkeerd is met de tijd, tenzij u de inhoud deelt.',
        ...
        SIGNUP_PRIVATE_KEY_WALLET_WARNING: 'Persoonlijke sleutel portomonnees gebruiken ALLEEN een wachtwoord om de geïmporteerde privé-sleutel te coderen. Daarom is het van cruciaal belang om een veilig wachtwoord te selecteren.',
