function DutchProvider($translateProvider) {
    ...
    $translateProvider.translations('nl', {
        ...
        TRANSFER_TRANSACTION_MOSAIC_TRANSFER: 'Mozaiek overdragen',
        TRANSFER_TRANSACTION_ATTACH_MOSAIC: 'Mozaiek bijvoegen',
        TRANSFER_TRANSACTION_ATTACH: 'Bijvoegen',
        TRANSFER_TRANSACTION_MOSAICS_ATTACHED: 'Mozaiek bijgevoegd',
        ...
        LINE_TX_DETAILS_MOS_ATTACHED: 'Mozaiek bijgevoegd',
        ...
        LINE_TX_DETAILS_MOS_CREATE: 'Creëer mozaiek',
        LINE_TX_DETAILS_MOS_EDIT: 'Bewerk mozaiek',
        ...
        LINE_TX_DETAILS_MULTISIG_AFFECTED: 'Account beinvloed',
        ...
        IMPORTANCE_TRANSFER_INFO_PART_2: 'Zorg ervoor dat je geen gedelegeerd account geactiveerd hebt (als het een geimporteerd account is). Je kunt de oude gedelegeerde openbare sleutel gebruiken om te deactiveren (indien nodig).',
        ...
        IMPORTANCE_TRANSFER_MULTISIG_NOT_INITIATOR: 'Je bent niet de mede-ondertekenaar die de belangrijke transactie heeft geinitieerd, daarom is het niet mogelijk om gedelegeerd oogsten te starten of te stoppen. Raadpleeg bovenstaande tab met informatie om te zien hoe je de controle terug krijgt over het gedelegeerd oogsten.',
        ...
        MOSAIC_DEFINITION_TITLE: 'Creëer mozaiek',
        MOSAIC_DEFINITION_NAME: 'Mozaiek definitie transactie',
        MOSAIC_DEFINITION_MULTISIG_NAME: 'Multi-handtekening mozaiek definitie transactie',
        ...
        MOSAIC_DEFINITION_MOSAIC_PROPERTIES: 'Mozaiek eigenschappen',
        MOSAIC_DEFINITION_REQUIRES_LEVY: 'Vereist heffing',
        MOSAIC_DEFINITION_LEVY_LIMITATION: 'UI-beperking: voor nu, alleen eigen mozaieks kunnen als heffing worden gebruikt.',
        MOSAIC_DEFINITION_LEVY_SELECT_MOSAIC: 'Selecteer een heffingsmozaiek',
        ...
        MOSAIC_DEFINITION_INFORMATION_TITLE: 'Creëren van een mozaiek',
        MOSAIC_DEFINITION_INFORMATION: 'Wil je meer informatie over mozaieken?',
        MOSAIC_DEFINITION_INFORMATION_1: 'De maximale lengte voor een mozaieknaam is 32 karakters. Toegestane karakters zijn:',
        ...
        MOSAIC_DEFINITION_INFORMATION_4: 'Het gedrag van een mozaiek kan worden aangepast door middel van eigenschappen:',
        MOSAIC_DEFINITION_INFORMATION_5: 'De voorraad wordt gegeven in gehele eenheden van het mozaiek, niet in de kleinste subeenheden. De initiële voorraad moet in het bereik van 0 en 9.000.000.000 liggen.',
        MOSAIC_DEFINITION_INFORMATION_6: 'De deelbaarheid bepaalt tot welke decimale plaats het mozaiek kan worden verdeeld. Zo betekent een verdeelbaarheid van 3 dat een mozaiek kan worden verdeeld in kleinste delen van 0.001 mozaieken, dat wil zeggen milli mozaieken is de kleinste subeenheid. De verdeelbaarheid moet in het bereik van 0 en 6 liggen.',
        MOSAIC_DEFINITION_INFORMATION_7: 'Indien geselecteerd, mag de mozaiekvoorraad later worden veranderd, anders is de voorraad onveranderlijk.',
        MOSAIC_DEFINITION_INFORMATION_8: 'Laat overdrachten van het mozaiek toe onder andere accounts dan de maker. Als de eigenschap \'overdraagbaar\' niet is geselecteerd, kunnen alleen transacties die de maker als afzender of als ontvanger hebben de mozaieken van dat type worden overgedragen. Indien geselecteerd, kunnen de mozaieken worden overgedragen naar en vanuit willekeurige accounts.',
        ...
        MOSAIC_DEFINITION_INFORMATION_10: 'Het mozaiek waarin de heffing moet worden betaald. Elk bestaand mozaiek kan worden geselecteerd.',
        ...
        MOSAIC_DEFINITION_INFORMATION_15: 'De heffing wordt opgegeven als percentage van de overgedragen hoeveelheid. De heffing stijgt dus lineair met de overgedragen mozaiekhoeveelheid.',
        MOSAIC_DEFINITION_INFORMATION_16: 'Het verzenden van mozaieken op het NEM blockchain vereist een heffing. De exacte heffing wordt berekend afhankelijk van het totale aantal en hoeveel worden verzonden tijdens een transactie. <b>Kleinschalige mozaieken</b> krijgen een kortingstarief van 1 XEM per mozaiek per overdracht. Dit zijn mozaieken met een hoeveelheid van minder dan 10.000 en een verdeelbaarheid van 0.',

        // EDIT MOSAIC MODULE
        MOSAIC_SUPPLY_CHANGE_TITLE: 'Verander mozaiekvoorraad',
        MOSAIC_SUPPLY_CHANGE_NAME: 'Mozaiekvoorraad wijzigingstransactie',
        MOSAIC_SUPPLY_CHANGE_MULTISIG_NAME: 'Multi-handtekening mozaiekvoorraad wijzigingstransactie',
        MOSAIC_SUPPLY_CHANGE_SELECT: 'Selecteer mozaiek',
        ...
        RENEW_NS_INFORMATION_4: 'Als ze niet op tijd worden vernieuwd, gaan alle sub-namespaces en mozaieken die erin zijn gemaakt verloren.',
        ...
        PORTAL_NS_TEXT: 'Namespaces zijn domeinnamen. Elke domeinnaam is uniek en verifieert mozaieken (bezittingen) die erop zijn uitgegeven of op de subdomeinen ervan.',
        PORTAL_NS_BTN: 'Creëer namespace',
        PORTAL_MOSAIC_TITLE: 'Mozaieken',
        PORTAL_MOSAIC_TEXT: 'NEM mozaieken zijn bezittingen die extra eigenschappen en andere kenmerken hebben. Om een mozaiek te kunnen creëren, moet een account ten minste één root namespace huren.',
        PORTAL_MOSAIC_BTN_1: 'Creëer mozaiek',
        PORTAL_MOSAIC_BTN_2: 'Bewerk mozaiek',
        ...
        APOSTILLE_IMPORT_FILES: 'Geimporteerde bestanden',
        ...
        APOSTILLE_MESSAGE_ADD_MOSAIC: 'Voeg mozaiek toe',
        ...
        ALERT_INVALID_MOSAIC_NAME: 'Naam van mozaiek is ongeldig!',
        ALERT_MOSAIC_DESCRIPTION: 'Beschrijving van mozaiek is ongeldig!',
        ALERT_GET_INCOMING_TXES_ERROR: 'Er is een fout opgetreden tijdens het ophalen van inkomende transacties, reden: ',
        ALERT_GET_MOSAICS_DEFINITIONS_ERROR: 'Fout bij het ophalen van mozaiekdefinities, reden:',
        ALERT_GET_SUB_NS_ERROR: 'Fout bij het ophalen van mozaiekdefinities, reden: ',
        ALERT_GET_MOSAICS_ERROR: 'Fout bij het ophalen van mozaieken, reden: ',
        ...
        ALERT_ADDRESS_BOOK_FILE_SUCCESS: 'Adresboek succesvol geimporteerd!',
        ...
        SIGNUP_PRIVATE_KEY_WALLET_WARNING: 'Persoonlijke sleutel portemonnees gebruiken ALLEEN een wachtwoord om de geimporteerde persoonlijke sleutel te coderen. Daarom is het van cruciaal belang om een veilig wachtwoord te selecteren.',
        ...
        SIGNUP_COMMON_WALLET_WARNING_BTN_1_INFO: 'Om een portemonneebestand te maken, maak een leeg tekstbestand en zet de bovenstaande BASE64-sleutel erin. <br>Sla het bestand op als <b><i>JePortemonneeNaam.wlt</i></b> en het kan nu geimporteerd worden.',
        ...
        FAQ_QUESTION_3: 'Waarom heb ik al een Mozaiek ?',
        FAQ_ANSWER_3: 'Omdat XEM de standaardvaluta van de NEM blockchain is, heeft elke gebruiker het al in hun portemonnee geregistreerd, zelfs als hun saldo 0. De namepsace is NEM en de mozaieknaam is XEM',
        ...
        // FORM RELATED
        FORM_PASSWORD_FIELD_PLACEHOLDER: 'Voer je portemonnee wachtwoord of wachtwoordzin in',
        ...
        FORM_MOSAIC_NAME_PLACEHOLDER: 'Mozaieknaam',
