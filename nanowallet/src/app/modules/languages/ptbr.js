function PortugueseBRProvider($translateProvider) {
    ...
    $translateProvider.translations('ptbr', {
        ...
        FAQ_ANSWER_11_1: 'Primeiro você deve verificar que o hash da sua transação está apontando para uma transação existente no <a target="_blank" href="https://nem.fyi/">explorador</a> (por favor, saiba que o explorador está sempre alguns blocos atrasado).',
        ...
        FAQ_ANSWER_12_2: 'Verifique o número do bloco e compare com o número exibido <a target="_blank" href="https://nem.fyi/nodes/">aqui</a>.',
