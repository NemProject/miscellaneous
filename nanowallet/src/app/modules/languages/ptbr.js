function PortugueseBRProvider($translateProvider) {
    ...
    $translateProvider.translations('ptbr', {
        ...
        DASHBOARD_NOTICE_1: 'Bem vindo a NEM Wallet!',
        DASHBOARD_NOTICE_2: 'Por favor <a href="https://github.com/NemProject/miscellaneous" target="_blank">reporte problemas aqui</a>.',
        DASHBOARD_NOTICE_3: 'O time da NEM sugere que você faça testes primeiramente na TestNet para familiarizar-se com a NEM Wallet, antes de utilizar a rede principal MainNet. Um guia simples pode ser encontrado <a href="https://docs.nem.io/pages/Guides/nanowallet/docs.en.html" target="_blank">aqui</a>. Os usuários são responsáveis pela segurança de seus fundos e por manter um backup seguro de todas as suas chaves privadas. O time da NEM não é responsável por nenhuma perda de fundos pelo uso indevido deste aplicativo na rede principal (MainNet).',
        ...
        FAQ_ANSWER_11_1: 'Primeiro você deve verificar que o hash da sua transação está apontando para uma transação existente no <a target="_blank" href="https://nemscan.io/">explorador</a> (por favor, saiba que o explorador está sempre alguns blocos atrasado).',
        ...
        FAQ_ANSWER_12_2: 'Verifique o número do bloco e compare com o número exibido <a target="_blank" href="https://nemnodes.org/nodes/">aqui</a>.',
